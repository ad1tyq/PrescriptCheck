    ...
    return (
        <>
            <div className="flex flex-col mx-10 my-10">
                ...
                <button className="bg-violet-400 w-fit cursor-pointer text-[clamp(10px,_1vw,_2vw)] py-2 px-4 rounded-md font-medium text-white mt-1 duration-300 hover:bg-violet-500" onClick={() => window.location.pathname = "/upload"}>Upload Prescription</button>
            </div>
        </>
    );
}
