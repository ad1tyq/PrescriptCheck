            ...
            h-auto py-10 px-8 gap-5 flex flex-col justify-center">
                ...
                <div className="flex flex-col gap-5">
                    ...
                    <div className="bg-red-300 flex flex-col gap-5 p-3 pb-6 rounded-lg shadow-lg">
                        <div className="flex justify-center w-[21rem] md:ml-[0.1rem] -ml-[3.5rem] mt-2 gap-5">
                            ...
                            <h1 className="text-xl md:mt-[1px] font-semibold md:hidden text-[clamp(0.9rem,1.2vw,1.2rem)]">High Risk
                        ...
                        {drugInteractInfo.HighRisk.length > 0 ? (
                            ...
                            <div key={`no-warnings`} className="ml-5 text-[clamp(0.9rem,1.1vw,1.1rem)]">
                                <b>No Warnings</b>
                            </div>
                        )}
                    </div>
                    ...
                    <div className="bg-amber-100 flex flex-col gap-5 p-3 pb-6 rounded-lg shadow-lg">
                        <div className="flex justify-center w-[13rem] md:ml-[0.5rem] mt-2 gap-5">
                        ...
                        {drugInteractInfo.DosageWarning.length > 0 ? (
                            drugInteractInfo.DosageWarning.map((dosage, index) => {
                                return (
                                    <div key={`dose${index}`} className="md:ml-5 mx-4 text-[clamp(0.9rem,1.1vw,1.1rem)]">
